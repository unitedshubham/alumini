          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style="color:red;">Rejected Blogs</h2>
...
require '../../connect.php';
$data = $conn->query("SELECT *,(select type_id from users where jobs.created_by=users.user_id) as type_id FROM jobs where status='2'")->fetchAll();
// and somewhere later:
foreach ($data as $row) {
  echo '  <tr>
                          <td>'.$row['job_title'].'</td>
