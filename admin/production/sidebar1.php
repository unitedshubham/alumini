...
// and somewhere later:
         ...
         if ($user_type=='admin') {
          ...
          <ul class="nav child_menu">
          <li><a href="../view_customers.php">View Students</a></li>
          ...
          <ul class="nav child_menu">
          <li><a href="../../orders/neworders.php">new request</a></li>
          <li><a href="../request/job_request.php">Job Request</a></li>
          <li><a href="../request/blog_request.php">Blog Request</a></li>
          </ul>
          </li>
