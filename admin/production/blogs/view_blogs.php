          ...
          <div class="x_content">
            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                require '../../connect.php';
                $data = $conn->query("SELECT * FROM blogs where status='1' AND created_by='".$user_id."'")->fetchAll();
// and somewhere later:
                foreach ($data as $row) {
                  ...
                  <td>'.$row['blog_picture'].'</td>
                  <td>'.$status.'</td>
                  
                  
                  <td><button onclick=\'viewfunc("' .$row["blog_id"]. '")\'><i class="fa fa-eye" style="color: blue;" >   </i></button>
                  <button onclick=\'deletefunc("' .$row["blog_id"]. '")\' ><i class="fa fa-trash" style="color: red;" >   </i></button>
                  <button onclick=\'editfunc("' .$row["blog_id"]. '")\'><i class="fa fa-pencil" style="color: blue;" >   </i></button></td>
                  </tr>';
