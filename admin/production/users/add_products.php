   ...
   margin-left: 10px;
    ...
    <option value="gifts">gifts</option>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text"  required="required" class="form-control " id="productname" name="productname">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text"  name="last-name" required="required" class="form-control" id="productdesc" name="productdesc">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input  class="date-picker form-control" required="required" type="text" id="price" name="price">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" >Discount percent <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input  class="date-picker form-control" required="required" type="text" id="discountperc" name="discountperc">
                        </div>
                      </div>
                      <br><br>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input  class="date-picker form-control" required="required" type="text" id="discprice" name="discprice">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input  class="date-picker form-control" required="required" type="text" id="stock" name="stock">
                        </div>
                      </div>
...
$("#submit").click(function(){
   ...
   var datastr= 'productname='+productname+'&productdesc='+productdesc+'&productnote='+productnote+'&discountperc='+discountperc+'&price='+price+'&discprice='+discprice+'&stock='+stock+'&offer='+offer+'&image1='+image1+'&image2='+image2+'&image3='+image3+'&image4='+image4+'&Category='+Category ;
