              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                 <select name="Category" id="Category" class="form-control">
                  <option value="Cakes">Conventions</option>
                  <option value="Cakes">College Event</option>
                  <option value="Cakes">Music festival</option>
                  <option value="Flowers">Networking Events</option>
                  <option value="Gifts">Press conferences</option>
                  <option value="Plants">Opening Ceremonies</option>
                  <option value="Cakes">Live Performances</option>
                  <option value="Cakes">Award Ceremonies</option>
                  <option value="Cakes">Charity Events</option>
                  <option value="Cakes">Fundraising Events</option>
                  <option value="Cakes">Seminars</option>
                  <option value="Cakes">Product Launches</option>
                  <option value="Cakes">Year End Functions</option>
                  <option value="Cakes">Trade Shows / Expos</option>
                  <option value="Cakes">Themed Parties</option>
...
<script type="text/javascript">
  ...
  else if (letters.test(eventname) == false) 
  {
    ...
    alert('enter product descrption');
  } 
