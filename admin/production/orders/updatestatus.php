...
.button3{
 ...
 <input type="hidden" id="id" name="id">
    ...
    <option value="outdelivery">outdelivery</option>
    ...
    <option value="completed">completed</option>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
      <input type="hidden"  required="required" class="form-control " id="pd_id" name="pd_id" disabled <?php echo 'value="'.$id.'"'
 ?>>
                        </div> 
                      </div>
...
$("#update").click(function(){
   ...
   var datastr= 'status='+status+'&pd_id='+pd_id;
